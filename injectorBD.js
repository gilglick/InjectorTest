...
function SetColors(){
 ...
 let sources = widgets[i].shadowRoot.querySelector('.ob-widget').querySelector('.ob-widget-items-container').querySelectorAll('.ob-rec-source');
        ...
        sources[j].style.color=document.getElementById("sourceColorinput").value;
        }
    }
//  document.querySelector('.OUTBRAIN').querySelector('.ob-widget').querySelector('.OUTBRAIN').shadowRoot.querySelector('.ob-widget').querySelector('.ob-widget-items-container').querySelector('.ob-rec-source').style.color = document.getElementById("sourceColorinput").value;
