...
<button  class="ob_injector"  id="showFeedfeatures" style="margin:15px auto;text-align: center;border:2px solid rgb(51, 63, 72)!important;border-radius:8px;width: 100%;background-color: #EF8421;font-family:Patua One, cursive;font-size: 14px;font-weight: bold;float: right;color:rgb(51, 63, 72) !important" onclick="ShowFeatures()"><span class="ob_injector">Change Fonts</span></button><br>
...
<div class="ob_injector"  id="innerSelectionDiv2" style="width:100%;height:max-content;"><button class="ob_injector" onclick="SetColors()" style="margin:15px auto; border:2px solid rgb(51, 63, 72)!important;border-radius:8px;width: 80%;left: 50%;background-color: #EF8421;font-family:Patua One, cursive;font-size: 14px;font-weight: bold;color:rgb(51, 63, 72) !important">Apply</button></div></div>
