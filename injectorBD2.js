...
var ob_q;
var outbrainDiv1;
const CSSPath = 'https://gilglick.github.io/InjectorTest/styles.css';
const OBJSPath = '//widgets.outbrain.com/outbrain.js';
...
function GetValues(element) {
    ...
    if (Ob_Widgets.length == 0 && document.getElementById('alertWidgets') != null) {
        document.getElementById('alertWidgets').style.display = 'none';
    }
    if (Ob_Widgets.length > 0 && document.getElementById('alertWidgets') != null) {
