...
<div class="ob_injector"  id="innerSelectionDiv2" style="width:100%;height:max-content;"><button class="ob_injector" id="setColors" onclick="SetColors()">Apply</button></div></div>
