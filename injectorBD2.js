...
<label for="sourceFeatures" class="ob_injector"> Source </label> <input type="text" style=“font-size: 13px;letter-spacing: 0.8px;text-indent: 5px;border: 2px solid rgb(51, 63, 72)!important;border-radius: 8px;width:100%;font-family:Patua One, cursive;font-weight:bold” type=“text” id="sourceColorinput" class="ob_injector" name="sourceFeatures" placeholder="Color"><input type="text" id="sourceSizeinput" class="ob_injector" name="sourceFeatures" placeholder="Size"> <br>
<div class="ob_injector"  id="innerSelectionDiv2" style="width:100%;height:max-content;"><button lass="ob_injector" onclick="SetColors()" style="margin:15px auto; border:2px solid rgb(51, 63, 72)!important;border-radius:8px;width: 80%;left: 50%;transform: translateX(-50%);background-color: #EF8421;font-family:Patua One, cursive;font-size: 14px;font-weight: bold;color:rgb(51, 63, 72) !important">Apply</button></div></div>
